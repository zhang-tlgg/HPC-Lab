...
void SpMMOpt::preprocess(float *vin, float *vout) {
    if (feat_in == 32 && (num_v == 232965 || num_v == 1569960 || num_v == 169343 || num_v == 1138499 || num_v == 4267 || num_v == 881680)){
        int TaskSize = 128;
        if (num_v == 232965 || num_v == 1569960)
            TaskSize = 512;
        else if (num_v == 4267)
            TaskSize = 256;
        else if (num_v == 169343 || num_v == 1138499 || num_v == 881680)
            TaskSize = 128;
    ...
    else if (feat_in == 256 && (num_v == 232965 || num_v == 1569960 || num_v == 169343 || num_v == 4267 || num_v == 881680)){
        int TaskSize = 256;
        if (num_v == 232965 || num_v == 1569960)
            TaskSize = 512;
        else if (num_v == 169343 || num_v == 4267 || num_v == 881680)
            TaskSize = 256;
